...
// The User_ProfileFunc type is an adapter to allow the use of ordinary
// function as User_Profile mutator.
type User_ProfileFunc func(context.Context, *ent.UserProfileMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f User_ProfileFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {

...
const file_lib_protos_google_api_http_proto_rawDesc = "" +
	"\n" +
	" lib/protos/google/api/http.proto\x12\n" +
	"google.api\"y\n" +
	"\x04Http\x12*\n" +
...
var (
	...
	file_lib_protos_google_api_http_proto_rawDescData []byte
)

func file_lib_protos_google_api_http_proto_rawDescGZIP() []byte {
	file_lib_protos_google_api_http_proto_rawDescOnce.Do(func() {
		file_lib_protos_google_api_http_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_lib_protos_google_api_http_proto_rawDesc), len(file_lib_protos_google_api_http_proto_rawDesc)))
	})
...
func file_lib_protos_google_api_http_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_lib_protos_google_api_http_proto_rawDesc), len(file_lib_protos_google_api_http_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,

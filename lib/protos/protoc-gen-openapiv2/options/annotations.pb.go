...
const file_lib_protos_protoc_gen_openapiv2_options_annotations_proto_rawDesc = "" +
	"\n" +
	"9lib/protos/protoc-gen-openapiv2/options/annotations.proto\x12)grpc.gateway.protoc_gen_openapiv2.options\x1a google/protobuf/descriptor.proto\x1a7lib/protos/protoc-gen-openapiv2/options/openapiv2.proto:~\n" +
...
func file_lib_protos_protoc_gen_openapiv2_options_annotations_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_lib_protos_protoc_gen_openapiv2_options_annotations_proto_rawDesc), len(file_lib_protos_protoc_gen_openapiv2_options_annotations_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 5,
			NumServices:   0,

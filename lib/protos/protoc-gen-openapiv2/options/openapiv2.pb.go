...
const file_lib_protos_protoc_gen_openapiv2_options_openapiv2_proto_rawDesc = "" +
	"\n" +
	"7lib/protos/protoc-gen-openapiv2/options/openapiv2.proto\x12)grpc.gateway.protoc_gen_openapiv2.options\x1a\x1cgoogle/protobuf/struct.proto\"\xb3\b\n" +
	"\aSwagger\x12\x18\n" +
...
var (
	...
	file_lib_protos_protoc_gen_openapiv2_options_openapiv2_proto_rawDescData []byte
)
...
func file_lib_protos_protoc_gen_openapiv2_options_openapiv2_proto_rawDescGZIP() []byte {
	file_lib_protos_protoc_gen_openapiv2_options_openapiv2_proto_rawDescOnce.Do(func() {
		file_lib_protos_protoc_gen_openapiv2_options_openapiv2_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_lib_protos_protoc_gen_openapiv2_options_openapiv2_proto_rawDesc), len(file_lib_protos_protoc_gen_openapiv2_options_openapiv2_proto_rawDesc)))
	})
...
func file_lib_protos_protoc_gen_openapiv2_options_openapiv2_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_lib_protos_protoc_gen_openapiv2_options_openapiv2_proto_rawDesc), len(file_lib_protos_protoc_gen_openapiv2_options_openapiv2_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   33,
			NumExtensions: 0,
			NumServices:   0,

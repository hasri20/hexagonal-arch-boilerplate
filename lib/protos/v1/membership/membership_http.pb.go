...
const OperationMembershipServiceGetUserInfo = "/fastcampus.membership.public.v1.MembershipService/GetUserInfo"
const OperationMembershipServiceSubmitLogin = "/fastcampus.membership.public.v1.MembershipService/SubmitLogin"
const OperationMembershipServiceSubmitLogout = "/fastcampus.membership.public.v1.MembershipService/SubmitLogout"
const OperationMembershipServiceSubmitRegistration = "/fastcampus.membership.public.v1.MembershipService/SubmitRegistration"
...
// GetUserInfo get user info
func (c *MembershipServiceHTTPClientImpl) GetUserInfo(ctx context.Context, in *UserInfoRequest, opts ...http.CallOption) (*UserInfoResponse, error) {
